...
class StoreRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'category_id.integer' => 'ID категорий должно быть числом.',
            'category_id.exists' => 'ID категорий должно быть в базе данных.',
            'tag_ids.array' => 'Необходимо передать массив данных.',
        ];
    }
}
