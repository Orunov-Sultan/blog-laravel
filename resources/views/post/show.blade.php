...
@section('content')
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{ $date->day }} {{ $date->translatedFormat('F') }}, {{ $date->year }} • {{ $date->format('H:i') }} • Комментарии • {{ $post->comments->count() }}</p>
